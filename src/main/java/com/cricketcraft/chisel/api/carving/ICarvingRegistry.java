...
public interface ICarvingRegistry {
     ...
     *         {@link World#playSound(double, double, double, String, float, float, boolean)} and other methods.
     */
     ...
     * @param block     The block of the variation
     * @param metadata  The metadata of the variation
     * @param order     The order of the variation in the list of all variations in the group. Higher numbers are sorted
     *                  at the end.
     */
