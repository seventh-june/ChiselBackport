 ...
 * <p>
 * This is an object that contains a collection of {@link ICarvingVariation} objects, and keeps them sorted. You may
 * sort them in any way (or not at all), and {@link ICarvingVariation#getOrder()} will likely be of use to do so.
 * <p>
...
public interface ICarvingGroup {
     ...
     * 
     * @param sound A string resource path for the sound this group makes when chiseled
     */
    void setSound(String sound);

    /**
     * The oredict name to match to this group. All items with this oredict name will be assumed to be part of this
     * group.
     * 
     ...
     * 
     * @param oreName The String oredict name to be associated with this group.
     */
    ...
    /**
     * Adds a variation to this group. Do not call this from external code, as it will fail to remove the inverse lookup
     * from the registry.
     * 
    ...
    /**
     * Removes a variation to this group. Do not call this from external code, as it will fail to remove the inverse
