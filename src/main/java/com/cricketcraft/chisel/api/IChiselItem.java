...
public interface IChiselItem {
     ...
     *               this.
     * @param chisel The {@link ItemStack} representing your chisel
    ...
    /**
     * Called to check if this {@link ItemStack} can be chiseled in this chisel. If not, there will be no possible
     * variants displayed in the GUI.
     * <p>
     ...
     * @param y        Y coord of the block being chiseled
     * @param z        Z coord of the block being chiseled
     * @param block    The {@link Block} being chiseled
