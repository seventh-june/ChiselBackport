...
/**
 * Use the enum constants (using {@link #key} or calling {@link #toString()}) in this class as keys for IMC messages
 * sent to chisel
 * <p>
...
public enum IMC {
     ...
     * <p>
     * An example would be {@code "mygroup|minecraft:dirt|1"} and this will add the vanilla dirt block with metadata 1
     * to the "mygroup" group, creating that group if need be.
     */
    ...
    /**
     * Registers an oredict name to a group. This can be used to automatically add all blocks with this oredict name to
     * a group. String syntax:
     * <p>
     * groupname|oredictname
     * <p>
     * An example would be {@code "mygroup|plankWood"} which will add all blocks registered in the oredict as
     * "plankWood" to your group called "mygroup".
     */
