...
public class ContainerChisel extends Container {
    ...
    public ItemStack slotClick(int par1, int par2, int par3, EntityPlayer par4EntityPlayer) {
        ...
        // if the player has clicked on the chisel or is trying to use a number key to force an itemstack into the slot
        // the chisel is in
        if (clickedSlot == chiselSlot || (par3 == 2 && par2 == chiselSlot)) return null;
    ...
    /**
     * Added validation of slot input Only Chiselable allowed
     *
     * @author Léa Gris
     */
    @Override
