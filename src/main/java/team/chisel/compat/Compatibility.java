...
public class Compatibility {
    ...
    private static void loadThaumcraftAspects() {
        // ThaumcraftApi.registerObjectTag(new ItemStack(ChiselBlocks.cobblestone, 1, OreDictionary.WILDCARD_VALUE),
        // (new AspectList()).add(Aspect.ENTROPY, 1).add(Aspect.EARTH, 1));
        // ThaumcraftApi.registerObjectTag(new ItemStack(ChiselBlocks.cobblestoneWall, 1, OreDictionary.WILDCARD_VALUE),
        // (new AspectList()).add(Aspect.ENTROPY, 1).add(Aspect.EARTH, 1));
    }
