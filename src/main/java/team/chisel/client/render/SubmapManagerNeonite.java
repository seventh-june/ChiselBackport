...
public class SubmapManagerNeonite extends SubmapManagerBase {
    ...
    public SubmapManagerNeonite(String color) {
        this.color = color;
    }
    ...
    public void registerIcons(String modName, Block block, IIconRegister register) {
        submap = new TextureSubmap(register.registerIcon(modName + ":Neonite/" + color + "-ctm"), 4, 4);
        submapSmall = new TextureSubmap(register.registerIcon(modName + ":Neonite/" + color), 2, 2);
    }
