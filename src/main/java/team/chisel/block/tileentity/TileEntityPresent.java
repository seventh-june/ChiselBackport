...
public class TileEntityPresent extends TileEntity implements IInventory, IDoubleChest {
    ...
    /**
     * @param preserveDir If true, this is only a virtual disconnect, meaning the other chest still exists, but is still
     *                    loaded, so maintain a cachedDir for reconnection upon chunk load.
     */
